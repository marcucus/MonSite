...
return (
  <>
    <div className="bg-[#010120] select-none flex flex-col justify-center items-center content-center p-10 py-20 xl:py-32">
        <div className='flex justify-center content-center items-center text-3xl text-[#e6d116] font-bold'>MES COMPETENCES</div>
